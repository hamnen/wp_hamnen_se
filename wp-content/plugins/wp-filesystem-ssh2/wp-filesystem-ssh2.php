 ...
 * WP Filesystem SSH2
 *
 * @link              https://www.fredericgilles.net/wp-filesystem-ssh2/
 * @since             1.0.0
 * @package           WP_Filesystem_SSH2
 *
 * @wordpress-plugin
 * Plugin Name:       WP Filesystem SSH2
 * Plugin URI:        https://www.fredericgilles.net/wp-filesystem-ssh2/
 * Description:       WordPress SSH2 Filesystem (using the phpseclib library)
 * Version:           1.0.0
