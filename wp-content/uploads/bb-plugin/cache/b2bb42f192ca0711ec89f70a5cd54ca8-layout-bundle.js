...
;(function($) {
	...
	var PPContentGridOptions = {
		...
		current_page: 'http://olle.dyndns-ip.com/hamnen_wordpress/hamnen_wordpress/artiklar/spektakulaert/',
		page: '0',
		is_tax: false,
		is_author: false,
		postSpacing: '6',
	...
	ppcg_5d788b1f7b636 = new PPContentGrid( PPContentGridOptions );
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d5bbe15e3ca6 .fl-photo-img' )
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d78ac7255428 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
;(function($) {
	...
	ppcg_5d78a92192ff7 = new PPContentGrid( PPContentGridOptions );
...
;(function($) {
	...
	ppcg_5d794cbbdb4fe = new PPContentGrid( PPContentGridOptions );
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d5aa335bea53 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d79438a94ccd .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
;(function($) {
	...
	ppcg_5d5aa335bea4b = new PPContentGrid( PPContentGridOptions );
...
;(function($) {
	...
	ppcg_5d5aa335bea65 = new PPContentGrid( PPContentGridOptions );
...
;(function($) {
	...
	ppcg_5d5aa335bea4c = new PPContentGrid( PPContentGridOptions );
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d5aa335bea61 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
;(function($) {
	...
	ppcg_5d5bbe9626efb = new PPContentGrid( PPContentGridOptions );
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d5aa335bea5d .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5d5aa335bea62 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
