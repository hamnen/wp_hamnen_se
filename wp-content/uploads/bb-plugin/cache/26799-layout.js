...
jQuery(document).ready(function($){
    $('h2 a').on('click touchstart',function(e){
        e.preventDefault();
        var dataURL = $(this).attr('href');
        $("#ifrm").attr("src", dataURL);
    }); 
...
$(".close, .popup-overlay").on("click touch", function(){
